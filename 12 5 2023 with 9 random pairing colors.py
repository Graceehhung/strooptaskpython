...
def display_instructions():
    ...
    while core.getTime() - start_time < 5.0 or not event.getKeys(keyList=['return']):
        pass
...
# Iterate through each color and color option
for color in colors:
    for option in colors:
        pairings.append((color, option))

# Shuffle the pairings to randomize the order
random.shuffle(pairings)

# Run 30 trials of the Stroop task
